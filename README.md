...
Known addresses verified during the exercise:
...
![Ping Success](03-success-ping.png)
...
![Fa0/3 no shutdown](06-no-shutdown-fa0/3-verification.png)
...
![Fa0/3 no shutdown verification](07-no-shutdown-fa0/3-verification.png)
